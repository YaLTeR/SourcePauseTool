...
ConVar y_spt_autojump_ensure_legit("y_spt_autojump_ensure_legit", "1", FCVAR_ARCHIVE);
ConVar y_spt_afterframes_reset_on_server_activate("y_spt_afterframes_reset_on_server_activate", "1", FCVAR_ARCHIVE);
