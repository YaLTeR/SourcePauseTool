...
namespace Patterns
{
	...
	const MemUtils::ptnvec ptnsSpawnPlayer =
	{
...

		{
			"6879",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x14, 0x80, 0x3D, '?', '?', '?', '?', '?', 0x56, 0x8B, 0xF1, 0x74, 0x0E, 0x6A, 0x00, 0xB9, '?', '?', '?', '?', 0xE8, '?', '?', '?', '?', 0xEB, 0x23
			},
	...
	const MemUtils::ptnvec ptnsSV_ActivateServer =
	{
...

		{
			"6879",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x08, 0x56, 0x57, 0x8B, 0x3D, '?', '?', '?', '?', 0x68, '?', '?', '?', '?', 0xFF, 0xD7, 0x83, 0xC4, 0x04, 0xE8, '?', '?', '?', '?', 0x8B, 0x10, 0x8B, 0xC8
			},
	...
	const MemUtils::ptnvec ptnsFinishRestore =
	{
...

		{
			"6879",
			{
				0x55, 0x8B, 0xEC, 0x81, 0xEC, '?', '?', '?', '?', 0x53, 0x8B, 0xD9, 0x8D, 0x8D, '?', '?', '?', '?', 0xE8, '?', '?', '?', '?', 0x80, 0xBB, '?', '?', '?', '?', '?', 0x75, 0x1B
			},
			"xxxxx????xxxxx????x????xx?????xx"
		}
	};
	...
	const MemUtils::ptnvec ptnsSetPaused =
	{
...

		{
			"6879",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x14, 0x56, 0x8B, 0xF1, 0x83, 0x7E, 0x04, 0x03, 0x74, 0x0B, 0x8B, 0x06, 0x8B, 0x50, 0x68, 0xFF, 0xD2, 0x84, 0xC0, 0x74, 0x46, 0x8B, 0x06, 0x8B, 0x50, 0x54, 0x8B, 0xCE
			},
	...
	const MemUtils::ptnvec ptnsMiddleOfSV_InitGameDLL =
	{
...

		{
			"4044",
			{
				0x8B, 0x0D, '?', '?', '?', '?', 0x8B, 0x01, 0x83, 0xC4, 0x14, 0xFF, 0x50, 0x24, 0xD9, 0x15, '?', '?', '?', '?', 0xDC, 0x1D, '?', '?', '?', '?', 0xDF, 0xE0, 0xF6, 0xC4, 0x05, 0x7B, 0x13
			},
	...
	const MemUtils::ptnvec ptnsCVRenderView__Push3DView =
	{
		{
			"5135",
			{
				0x8B, 0x54, 0x24, 0x10, 0x8B, '?', '?', '?', '?', '?', 0x8B, 0x01, 0x8B, 0x40, 0x58, 0x6A, 0x00, 0x52, 0x8B, 0x54, 0x24, 0x14, 0x52, 0x8B, 0x54, 0x24, 0x14, 0x52, 0x8B, 0x54, 0x24, 0x14, 0x52, 0xFF, 0xD0, 0xC2, 0x10, 0x00
			},
	...
	const MemUtils::ptnvec ptnsDoImageSpaceMotionBlur =
	{
...

		{
			"1910503",
			{
				0x53, 0x8B, 0xDC, 0x83, 0xEC, 0x08, 0x83, 0xE4, 0xF0, 0x83, 0xC4, 0x04, 0x55, 0x8B, 0x6B, 0x04, 0x89, 0x6C, 0x24, 0x04, 0x8B, 0xEC, 0xA1, '?', '?', '?', '?', 0x81, 0xEC, '?', '?', '?', '?', 0x83, 0x78, 0x30, 0x00, 0x56, 0x57, 0x0F, 0x84, '?', '?', '?', '?', 0x8B, 0x0D
			},
			"xxxxxxxxxxxxxxxxxxxxxxx????xx????xxxxxxxx????xx"
		},
		
		{
			"missinginfo1_6",
			{
				0x55, 0x8B, 0xEC, 0xA1, '?', '?', '?', '?', 0x81, 0xEC, '?', '?', '?', '?', 0x83, 0x78, 0x30, 0x00, 0x0F, 0x84, '?', '?', '?', '?', 0x8B, 0x0D, '?', '?', '?', '?', 0x8B, 0x11
			},
	...
	const MemUtils::ptnvec ptnsClientCheckJumpButton =
	{
...

		{
			"2257546",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x14, 0x56, 0x8B, 0xF1, 0x8B, 0x4E, 0x04, 0x80, 0xB9, '?', '?', '?', '?', '?', 0x74, 0x0E, 0x8B, 0x46, 0x08, 0x83, 0x48, 0x28, 0x02, 0x32, 0xC0, 0x5E, 0x8B, 0xE5
			},
...

		{
			"2257546-hl1",
			{
				0x55, 0x8B, 0xEC, 0x51, 0x56, 0x8B, 0xF1, 0x57, 0x8B, 0x7E, 0x04, 0x85, 0xFF, 0x74, 0x2B, 0x8B, 0x07, 0x8B, 0xCF, 0x8B, 0x80,  '?', '?', '?', '?', 0xFF, 0xD0, 0x84, 0xC0, 0x74, 0x1B, 0x6A, 0x00
			},
...

		{
			"2707",
			{
				0x83, 0xEC, 0x10, 0x53, 0x56, 0x8B, 0xF1, 0x8B, 0x4E, 0x08, 0x8A, 0x81, '?', '?', '?', '?', 0x84, 0xC0, 0x74, 0x0F, 0x8B, 0x76, 0x04, 0x83, 0x4E, 0x28, 0x02, 0x5E, 0x32, 0xC0, 0x5B, 0x83, 0xC4, 0x10
			},
...

		{
			"4044-episodic",
			{
				0x83, 0xEC, 0x10, 0x56, 0x8B, 0xF1, 0x8B, 0x4E, 0x08, 0x80, 0xB9, '?', '?', '?', '?', '?', 0x0F, 0x85, '?', '?', '?', '?', 0xD9, 0x05, '?', '?', '?', '?', 0xD9, 0x81
			},
...

		{
			"1910503",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x14, 0x56, 0x8B, 0xF1, 0x8B, 0x4E, 0x04, 0x80, 0xB9, '?', '?', '?', '?', '?', 0x74, 0x0E, 0x8B, 0x76, 0x08, 0x83, 0x4E, 0x28, 0x02, 0x32, 0xC0, 0x5E, 0x8B, 0xE5
			},
			"xxxxxxxxxxxxxx?????xxxxxxxxxxxxxx"
		},

		{
			"6879",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x0C, 0x56, 0x8B, 0xF1, 0x8B, 0x4E, 0x04, 0x80, 0xB9, '?', '?', '?', '?', '?', 0x74, 0x07, 0x32, 0xC0, 0x5E, 0x8B, 0xE5, 0x5D, 0xC3, 0x53, 0xBB
			},
		...
		
		{
			"missinginfo1_4_7",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x3C, 0x56, 0x89, 0x4D, 0xD8, 0x8B, 0x45, 0xD8, 0x8B, 0x48, 0x08, 0x81, 0xC1, '?', '?', '?', '?', 0xE8, '?', '?', '?', '?', 0x0F, 0xB6, 0xC8, 0x85, 0xC9
			},
		...
		
		{
			"missinginfo1_6",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x18, 0x56, 0x8B, 0xF1, 0x8B, 0x4E, 0x04, 0x80, 0xB9, '?', '?', '?', '?', '?', 0x74, 0x0E, 0x8B, 0x76, 0x08, 0x83, 0x4E, 0x28, 0x02, 0x32, 0xC0, 0x5E, 0x8B, 0xE5
			},
			"xxxxxxxxxxxxxx?????xxxxxxxxxxxxxx"
		}
	};
	...
	const MemUtils::ptnvec ptnsHudUpdate =
	{
...

		{
			"dmomm",
			{
				0x51, 0xA1, '?', '?', '?', '?', 0x8B, 0x48, 0x10, 0x89, 0x0C, 0x24, 0xD9, 0x04, 0x24, 0x83, 0xEC, 0x08, 0xDD, 0x1C, 0x24, 0xE8, '?', '?', '?', '?', 0x8B, 0xC8, 0xE8
			},
		...
		
		{
			"6879",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x24, 0xA1, '?', '?', '?', '?', 0xF3, 0x0F, 0x10, 0x40, '?', 0x53, 0x56, 0xF3, 0x0F, 0x11, 0x45, '?', 0x83, 0xEC, 0x08, 0x0F, 0x5A, 0xC0, 0xF2, 0x0F, 0x11, 0x04, 0x24
			},
		...
		
		{
			"missinginfo1_4_7",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x08, 0x89, 0x4D, 0xF8, 0xA1, '?', '?', '?', '?', 0x8B, 0x48, 0x10, 0x89, 0x4D, 0xFC, 0xE8, '?', '?', '?', '?', 0xD9, 0x45, 0xFC, 0x83, 0xEC, 0x08, 0xDD, 0x1C, 0x24
			},
	...
	const MemUtils::ptnvec ptnsGetButtonBits =
	{
		...
		
		{
			"4044-episodic",
			{
				0x56, 0xB0, 0x03, 0x33, 0xF6, 0x84, 0x05, '?', '?', '?', '?', 0x74, 0x05, 0xBE, '?', '?', '?', '?', 0x8B, 0x15, '?', '?', '?', '?', 0xF7, 0xC2, '?', '?', '?', '?', 0xB9
			},
			"xxxxxxx????xxx????xx????xx????x"
		},
		
		{
			"6879",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x0C, 0x56, 0x8B, 0xF1, 0x8B, 0x0D, '?', '?', '?', '?', 0x8B, 0x01, 0x8B, 0x90, '?', '?', '?', '?', 0x57, 0x89, 0x75, 0xF8, 0xFF, 0xD2, 0x8B, 0xF8, 0xC7, 0x45
			},
		...
		
		{
			"missinginfo1_4_7",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x08, 0x89, 0x4D, 0xF8, 0xC7, 0x45, '?', '?', '?', '?', '?', 0x83, 0x7D, 0x08, 0x00, 0x0F, 0x95, 0xC0, 0x50, 0x68, '?', '?', '?', '?', 0x8B, 0x0D
			},
	...
	const MemUtils::ptnvec ptnsCreateMove =
	{
		...
		
		{
			"1910503",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x50, 0x53, 0x8B, 0xD9, 0x8B, 0x4D, 0x08, 0xB8, '?', '?', '?', '?', 0xF7, 0xE9, 0x03, 0xD1, 0xC1, 0xFA, 0x06, 0x8B, 0xC2, 0xC1, 0xE8, 0x1F, 0x03, 0xD0, 0x0F, 0x57, 0xC0
			},
		...
		
		{
			"2257546",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x54, 0x53, 0x56, 0x8B, 0x75, 0x08, 0xB8, '?', '?', '?', '?', 0xF7, 0xEE, 0x57, 0x03, 0xD6, 0x8B, 0xF9, 0xC1, 0xFA, 0x06, 0x8B, 0xCE, 0x8B, 0xC2, 0xC1, 0xE8, 0x1F
			},
		...
		
		{
			"2257546-hl1",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x50, 0x53, 0x8B, 0x5D, 0x08, 0xB8, '?', '?', '?', '?', 0xF7, 0xEB, 0x56, 0x03, 0xD3, 0xC1, 0xFA, 0x06, 0x8B, 0xC2, 0xC1, 0xE8, 0x1F, 0x03, 0xC2, 0x8B, 0xD3
			},
	...
	const MemUtils::ptnvec ptnsMiddleOfCAM_Think =
	{
		...
		
		{
			"1910503",
			{
				0xF3, 0x0F, 0x7E, 0x45, '?', 0x8B, 0x4D, 0xD0, 0x83, 0xEC, 0x0C, 0x8B, 0xC4, 0x66, 0x0F, 0xD6, 0x00, 0x89, 0x48, 0x08, 0xE8, '?', '?', '?', '?', 0x50, 0xB9, '?', '?', '?', '?', 0xE8
			},
			"xxxx?xxxxxxxxxxxxxxxx????xx????x"
		},
		
		{
			"2257546",
			{
				0x8B, 0x45, 0xD4, 0x83, 0xEC, 0x0C, 0x8B, 0xD4, 0x89, 0x02, 0x8B, 0x45, 0xD8, 0x89, 0x42, 0x04, 0x8B, 0x45, 0xDC, 0x89, 0x42, 0x08, 0xE8, '?', '?', '?', '?', 0x50, 0xB9
			},
	...
	const MemUtils::ptnvec ptnsGetGroundEntity =
	{
		...
		
		{
			"1910503",
			{
				0x8B, 0x81, 0x50, 0x02, 0x00, 0x00, 0x83, 0xF8, 0xFF, 0x74, 0x1F, 0x8B, 0x15, '?', '?', '?', '?', 0x8B, 0xC8, 0x81, 0xE1, '?', '?', '?', '?', 0x03, 0xC9, 0x8D, 0x4C, 0xCA, 0x04, 0xC1, 0xE8, 0x0C
			},
		...
		
		{
			"2257546",
			{
				0x8B, 0x91, 0x50, 0x02, 0x00, 0x00, 0x83, 0xFA, 0xFF, 0x74, 0x1D, 0xA1, '?', '?', '?', '?', 0x8B, 0xCA, 0x81, 0xE1, '?', '?', '?', '?', 0xC1, 0xEA, 0x0C, 0x03, 0xC9, 0x39, 0x54, 0xC8, 0x08
			},
	...
	const MemUtils::ptnvec ptnsCalcAbsoluteVelocity =
	{
		...
		
		{
			"1910503",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x20, 0x57, 0x8B, 0xF9, 0xF7, 0x87, '?', '?', '?', '?', '?', '?', '?', '?', 0x0F, 0x84, '?', '?', '?', '?', 0x53, 0x56, 0x8D, 0x9F
			},
			"xxxxxxxxxxx????????xx????xxxx"
		},
		
		{
			"2257546",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x20, 0x57, 0x8B, 0xF9, 0xF7, 0x87, '?', '?', '?', '?', '?', '?', '?', '?', 0x0F, 0x84, '?', '?', '?', '?', 0x56, 0x8D, 0xB7
			},
			"xxxxxxxxxxx????????xx????xxx"
		}
	};
	...
	const MemUtils::ptnvec ptnsCViewRender__OnRenderStart =
	{
		...
		
		{
			"missinginfo1_4_7",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x24, 0x89, 0x4D, 0xE0, 0xB9, '?', '?', '?', '?', 0xE8, '?', '?', '?', '?', 0xD8, 0x1D, '?', '?', '?', '?', 0xDF, 0xE0, 0xF6, 0xC4, 0x05, 0x7A, 0x5A
			},
	...
	{
		{
			"5135",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xE4, 0xF8, 0x81, 0xEC, 0x24, 0x01, 0x00, 0x00, 0x53, 0x56, 0x57, 0x8B, 0xF9, 0x8D, 0x8F, 0x20, 0x01, 0x00, 0x00, 0x89, 0x7C, 0x24, 0x24, 0xE8
			},
			"xxxxxxxxxxxxxxxxxxxxxxxxxxxx"
		}
	};

	const MemUtils::ptnvec ptnsCViewRender__ViewDrawScene =
	{
		{
			"5135",
			{
				0x51, 0xA1, '?', '?', '?', '?', 0x55, 0x56, 0x8B, 0xF1, 0x8B, 0x48, 0x04, 0x83, 0xE9, 0x01, 0x89
			},
			"xx????xxxxxxxxxxx"
		}
	};

	const MemUtils::ptnvec ptnsCViewRender__DrawOneMonitor =
	{
		{
			"5135",
			{
				0x81, 0xEC, 0x28, 0x01, 0x00, 0x00, 0xF6, '?', '?', '?', '?', '?', '?', 0x89, 0x4C, 0x24, 0x0C, 0x75, 0x2C, 0x8B, '?', '?', '?', '?', '?', 0x83, '?', '?', '?', '?', '?', '?', 0x6A, 0x00, 0x68, '?', '?', '?', '?', 0xFF, '?', '?', '?', '?', '?', 0x68, '?', '?', '?', '?', 0xA3, '?', '?', '?', '?', 0xE8, '?', '?', '?', '?', 0x83, 0xC4, 0x04, 0xA1, '?', '?', '?', '?', 0x83, 0x00, 0x01, 0x53, 0x55 
			},
			"xxxxxxx??????xxxxxxx?????x??????xxx????x?????x????x????x????xxxx????xxxxx"
		}
	};

	const MemUtils::ptnvec ptnsCViewRender__DrawMonitors =
	{
		{
			"5135",
			{
				0x83, 0xEC, 0x0C, 0x8B, 0x44, 0x24, 0x10, 0x57, 0x50, 0x89, 0x4C, 0x24, 0x10, 0x51, 0x8B, '?', '?', '?', '?', '?', 0xE8, '?', '?', '?', '?', 0xE8, '?', '?', '?', '?', 0x8B, 0xF8, 0x85, 0xFF, 0x74, 0x7B

			},
			"xxxxxxxxxxxxxxx?????x????x????xxxxxx"
		}
	};

	const MemUtils::ptnvec ptnsCPortalRenderable_FlatBasic__RenderPortalViewToTexture =
	{
		{
			"5135",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xE4, 0xF8, 0x81, 0xEC, 0x2C, 0x03, 0x00, 0x00, 0xD9, 0xE8, 0x53, 0x8B, 0xD9, 0xD8, 0x9B, 0xFC, 0x01, 0x00, 0x00, 0x56, 0x57
			},
			"xxxxxxxxxxxxxxxxxxxxxxxxx"
		}
	};

	const MemUtils::ptnvec ptnsCViewRender__QueueOverlayRenderView =
	{
		{
			"5135",
			{
				0x8B, 0x44, 0x24, 0x04, 0x56, 0x8B, 0xF1, 0x50, 0x8D, '?', '?', '?', '?', '?', 0xC6, '?', '?', '?', '?', '?', '?', 0xE8 
			},
			"xxxxxxxxx?????x??????x"
		}
	};

	const MemUtils::ptnvec ptnsReleaseRenderTargets =
	{
		{
			"5135",
			{
				0x56, 0x6A, 0x00, 0xB9, '?', '?', '?', '?', 0xE8, '?', '?', '?', '?', 0x6A, 0x00, 0xB9, '?', '?', '?', '?', 0xE8, '?', '?', '?', '?', 0x6A, 0x00, 0xB9, '?', '?', '?', '?', 0xE8, '?', '?', '?', '?', 0x6A, 0x00, 0xB9, '?', '?', '?', '?', 0xE8, '?', '?', '?', '?', 0x6A, 0x00, 0xB9, '?', '?', '?', '?', 0xE8, '?', '?', '?', '?', 0x6A, 0x00, 0xB9, '?', '?', '?', '?', 0xE8, '?', '?', '?', '?', 0x6A, 0x00, 0xB9, '?', '?', '?', '?', 0xE8, '?', '?', '?', '?', 0xBE, '?', '?', '?', '?', 0x8D, 0x9B, 0x00, 0x00, 0x00, 0x00
			},
			"xxxx????x????xxx????x????xxx????x????xxx????x????xxx????x????xxx????x????xxx????x????x????xxxxxx"
		}
	};

	const MemUtils::ptnvec ptnsCViewRender__Render =
	{
		{
			"5135",
			{
				0x81, 0xEC, 0x98, 0x00, 0x00, 0x00, 0x53, 0x56, 0x57, 0x6A, 0x04, 0x6A, 0x00, 0x68, '?', '?', '?', '?', 0x6A, 0x00, 0x8B, 0xF1, 0x8B, '?', '?', '?', '?', '?', 0x68, '?', '?', '?', '?', 0xFF, '?', '?', '?', '?', '?', 0x8B, 0xBC, 0x24, 0xA8, 0x00, 0x00, 0x00, 0x8B, 0x4F, 0x04
			},
			"xxxxxxxxxxxxxx????xxxxx?????x????x?????xxxxxxxxxx"
		}
	};

	const MemUtils::ptnvec ptnsCHUDCrosshair__Paint =
	{
		{
			"5135",
			{
				0x83, 0xEC, 0x3C, 0x56, 0x8B, 0xF1, 0x83, 0xBE, 0xF0, 0x00, 0x00, 0x00, 0x00, 0x0F, 0x84, 0xDB, 0x01, 0x00, 0x00, 0xE8, '?', '?', '?', '?', 0x84, 0xC0, 0x0F, 0x84, 0xCE, 0x01, 0x00, 0x00, 0xE8, '?', '?', '?', '?', 0xD9, 0x00, 0xD9, 0x9E, 0x08, 0x01, 0x00, 0x00, 0xD9, 0x40, 0x04
			},
			"xxxxxxxxxxxxxxxxxxxx????xxxxxxxxx????xxxxxxxxxxx"
		}
	};
	...
	const MemUtils::ptnvec ptnsServerCheckJumpButton =
	{
...

		{
			"2257546-hl1",
			{
				0x55, 0x8B, 0xEC, 0x51, 0x56, 0x8B, 0xF1, 0x57, 0x8B, 0x7E, 0x04, 0x85, 0xFF, 0x74, 0x10, 0x8B, 0x07, 0x8B, 0xCF, 0x8B, 0x80, '?', '?', '?', '?', 0xFF, 0xD0, 0x84, 0xC0, 0x75, 0x02, 0x33, 0xFF
			},
			"xxxxxxxxxxxxxxxxxxxxx????xxxxxxxx"
		},
...

		{
			"dmomm",
			{
				0x81, 0xEC, '?', '?', '?', '?', 0x56, 0x8B, 0xF1, 0x8B, 0x4E, 0x10, 0x80, 0xB9, '?', '?', '?', '?', '?', 0x74, 0x11, 0x8B, 0x76, 0x0C, 0x83, 0x4E, 0x28, 0x02, 0x32, 0xC0, 0x5E, 0x81, 0xC4
			},
...

		{
			"4044-episodic",
			{
				0x83, 0xEC, 0x14, 0x56, 0x8B, 0xF1, 0x8B, 0x4E, 0x08, 0x80, 0xB9, '?', '?', '?', '?', '?', 0x0F, 0x85, '?', '?', '?', '?', 0xD9, 0x05, '?', '?', '?', '?', 0xD9, 0x81
			},
			"xxxxxxxxxxx?????xx????xx????xx"
		},
		...
		
		{
			"missinginfo1_4_7",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x44, 0x56, 0x89, 0x4D, 0xD0, 0x8B, 0x45, 0xD0, 0x8B, 0x48, 0x08, 0x81, 0xC1, '?', '?', '?', '?', 0xE8, '?', '?', '?', '?', 0x0F, 0xB6, 0xC8, 0x85, 0xC9
			},
			"xxxxxxxxxxxxxxxxxx????x????xxxxx"
		},
		
		{
			"missinginfo1_6",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x1C, 0x56, 0x8B, 0xF1, 0x8B, 0x4E, 0x04, 0x80, 0xB9, '?', '?', '?', '?', '?', 0x74, 0x0E, 0x8B, 0x76, 0x08, 0x83, 0x4E, 0x28, 0x02, 0x32, 0xC0, 0x5E, 0x8B, 0xE5
			},
			"xxxxxxxxxxxxxx?????xxxxxxxxxxxxxx"
		}
	};
	...
	const MemUtils::ptnvec ptnsFinishGravity =
	{
		...
		
		{
			"2707",
			{
				0x8B, 0x51, 0x08, 0xD9, 0x82, '?', '?', '?', '?', 0xD8, 0x1D, '?', '?', '?', '?', 0xDF, 0xE0, 0xF6, 0xC4, 0x44, 0x7A, 0x4D, 0xD9, 0x82, '?', '?', '?', '?', 0xD8, 0x1D
			},
		...
		
		{
			"4044",
			{
				0x8B, 0x51, 0x08, 0xD9, 0x05, '?', '?', '?', '?', 0xD9, 0x82, '?', '?', '?', '?', 0xDA, 0xE9, 0xDF, 0xE0, 0xF6, 0xC4, 0x44, 0x7A, 0x4F, 0xD9, 0x05, '?', '?', '?', '?', 0xD9, 0x82
			},
		...
		
		{
			"4104",
			{
				0xD9, 0xEE, 0x8B, 0x51, 0x08, 0xD8, 0x92, '?', '?', '?', '?', 0xDF, 0xE0, 0xF6, 0xC4, 0x44, 0x7A, 0x3F, 0xD8, 0x9A, '?', '?', '?', '?', 0xDF, 0xE0, 0xF6, 0xC4, 0x44, 0x7B, 0x08, 0xD9, 0x82
			},
		...
		
		{
			"5135",
			{
				0xD9, 0xEE, 0x8B, 0x51, 0x04, 0xD8, 0x92, '?', '?', '?', '?', 0xDF, 0xE0, 0xF6, 0xC4, 0x44, 0x7A, 0x3F, 0xD8, 0x9A, '?', '?', '?', '?', 0xDF, 0xE0, 0xF6, 0xC4, 0x44, 0x7B, 0x08, 0xD9, 0x82
			},
			"xxxxxxx????xxxxxxxxx????xxxxxxxxx"
		},
		
		{
			"2257546",
			{
				0x55, 0x8B, 0xEC, 0x51, 0x0F, 0x57, 0xC9, 0x57, 0x8B, 0xF9, 0x8B, 0x57, 0x04, 0xF3, 0x0F, 0x10, 0x82, '?', '?', '?', '?', 0x0F, 0x2E, 0xC1, 0x9F, 0xF6, 0xC4, 0x44, 0x7A, 0x47, 0xF3, 0x0F, 0x10, 0x82
			},
		...
		
		{
			"6879",
			{
				0x8B, 0x51, 0x04, 0xF3, 0x0F, 0x10, 0x8A, '?', '?', '?', '?', 0x0F, 0x57, 0xC0, 0x0F, 0x2E, 0xC8, 0x9F, 0xF6, 0xC4, 0x44, 0x0F, 0x8A, '?', '?', '?', '?', 0xF3, 0x0F, 0x10, 0x8A
			},
		...
		
		{
			"missinginfo1_4_7",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x0C, 0x89, 0x4D, 0xF8, 0x8B, 0x45, 0xF8, 0x8B, 0x48, 0x08, 0xD9, 0x05, '?', '?', '?', '?', 0xD9, 0x81, '?', '?', '?', '?', 0xDA, 0xE9, 0xDF, 0xE0, 0xF6, 0xC4, 0x44
			},
		...
		
		{
			"missinginfo1_6",
			{
				0x8B, 0x51, 0x04, 0xD9, 0x82, '?', '?', '?', '?', 0xD9, 0xEE, 0xD9, 0xC0, 0xDD, 0xEA, 0xDF, 0xE0, 0xDD, 0xD9, 0xF6, 0xC4, 0x44, 0x7A, 0x3F, 0xD9, 0x82, '?', '?', '?', '?', 0xDA, 0xE9
			},
	...
	const MemUtils::ptnvec ptnsPlayerRunCommand =
	{
...

		{
			"2707",
			{
				0x8B, 0x81, '?', '?', '?', '?', 0x8B, 0x54, 0x24, 0x04, 0x53, 0x33, 0xDB, 0x3B, 0xC3, 0x88, 0x99, '?', '?', '?', '?', 0x75, 0x1B, 0x8B, 0x42, 0x0C, 0x89, 0x81
			},
		...
		
		{
			"4044",
			{
				0x8B, 0x54, 0x24, 0x04, 0x53, 0x33, 0xDB, 0x39, 0x99, '?', '?', '?', '?', 0x88, 0x99, '?', '?', '?', '?', 0x75, 0x1B, 0x8B, 0x42, 0x0C, 0x89, 0x81, '?', '?', '?', '?', 0x8B, 0x42, 0x10
			},
		...
		
		{
			"6879",
			{
				0x55, 0x8B, 0xEC, 0x56, 0x8B, 0x75, 0x08, 0x57, 0x8B, 0xF9, 0x33, 0xC0, 0x88, 0x87, '?', '?', '?', '?', 0x39, 0x87, '?', '?', '?', '?', 0x75, 0x1B, 0xD9, 0x46, 0x0C, 0xD9, 0x9F
			},
		...
		
		{
			"missinginfo1_6",
			{
				0x55, 0x8B, 0xEC, 0x56, 0x8B, 0x75, 0x08, 0x57, 0x8B, 0xF9, 0x33, 0xC9, 0x88, 0x8F, '?', '?', '?', '?', 0x39, 0x8F, '?', '?', '?', '?', 0x75, 0x1B, 0xD9, 0x46, 0x0C, 0xD9, 0x9F
			},
			"xxxxxxxxxxxxxx????xx????xxxxxxx"
		}
	};
	...
	const MemUtils::ptnvec ptnsCheckStuck =
	{
...

		{
			"2707",
			{
				0x81, 0xEC, '?', '?', '?', '?', 0x53, 0x56, 0x8B, 0xF1, 0x57, 0x8D, 0x4C, 0x24, 0x6C, 0xC7, 0x44, 0x24, '?', '?', '?', '?', '?', 0xE8, '?', '?', '?', '?', 0xE8
			},
			"xx????xxxxxxxxxxxx?????x????x"
		},
		...
		
		{
			"4044-episodic",
			{
				0x81, 0xEC, '?', '?', '?', '?', 0x56, 0x57, 0x8B, 0xF1, 0xC7, 0x44, 0x24, '?', '?', '?', '?', '?', 0xE8, '?', '?', '?', '?', 0x8B, 0x4E, 0x04, 0x8D, 0x44, 0x24, 0x34, 0x50, 0x6A, 0x08
			},
		...
		
		{
			"2257546",
			{
				0x55, 0x8B, 0xEC, 0x81, 0xEC, '?', '?', '?', '?', 0x56, 0x8B, 0xF1, 0xC7, 0x45, '?', '?', '?', '?', '?', 0xE8, '?', '?', '?', '?', 0x8B, 0x46, 0x08, 0x8D, 0x4D, 0x80, 0x8B, 0x16
			},
		...
		
		{
			"6879",
			{
				0x55, 0x8B, 0xEC, 0x81, 0xEC, '?', '?', '?', '?', 0x53, 0x56, 0x57, 0x8B, 0xF1, 0xC7, 0x45, '?', '?', '?', '?', '?', 0xE8, '?', '?', '?', '?', 0x8B, 0x46, 0x08, 0x8B, 0x16, 0x8B, 0x92
			},
		...
		
		{
			"missinginfo1_4_7",
			{
				0x55, 0x8B, 0xEC, 0x81, 0xEC, '?', '?', '?', '?', 0x89, 0x8D, '?', '?', '?', '?', 0x8D, 0x4D, 0xEC, 0xE8, '?', '?', '?', '?', 0x8D, 0x4D, 0x80, 0xE8, '?', '?', '?', '?', 0x8D, 0x8D
			},
		...
		
		{
			"missinginfo1_6",
			{
				0x55, 0x8B, 0xEC, 0x81, 0xEC, '?', '?', '?', '?', 0x56, 0x8B, 0xF1, 0xC7, 0x45, '?', '?', '?', '?', '?', 0xE8, '?', '?', '?', '?', 0x8B, 0x46, 0x08, 0x8B, 0x16, 0x8B, 0x92
			},
			"xxxxx????xxxxx?????x????xxxxxxx"
		}
	};

	const MemUtils::ptnvec ptnsMiddleOfSlidingFunction =
	{
		{
			"dmomm",
			{
				0x8B, 0x16, 0x8B, 0xCE, 0xFF, 0x92, '?', '?', '?', '?', 0x8B, 0x08, 0x89, 0x4C, 0x24, 0x1C, 0x8B, 0x50, 0x04, 0x89, 0x54, 0x24, 0x20, 0x8B, 0x40, 0x08, 0x8D, 0x4C, 0x24, 0x10, 0x51, 0x8D, 0x54, 0x24, 0x20
			},
