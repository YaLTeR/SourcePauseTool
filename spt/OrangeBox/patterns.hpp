...
namespace Patterns
{
	...
	const MemUtils::ptnvec ptnsVGui_Paint =
	{
		{
			"5135",
			{
				0xE8, '?', '?', '?', '?', 0x8B, 0x10, 0x8B, 0x52, 0x34, 0x8B, 0xC8, 0xFF, 0xE2, 0xCC, 0xCC
			},
			"x????xxxxxxxxxxx"
		}
	};
	...
	const MemUtils::ptnvec ptnsCHL2_Player__HandleInteraction =
	{
		{
			"5135",
			{
				0x8B, 0x44, 0x24, 0x04, 0x3B, 0x05, '?', '?', '?', '?', 0x74, 0x36, 0x3B, 0x05, '?', '?', '?', '?', 0x75, 0x15, 0x83, 0xA1, '?', '?', '?', '?', '?', 0x6A, 0x00, 0x6A, 0x02, 0xE8, '?', '?', '?', '?', 0xB0, 0x01, 0xC2, 0x0C, 0x00
			},
			"xxxxxx????xxxx????xxxx?????xxxxx????xxxxx"
		}
	};

	const MemUtils::ptnvec ptnsGetStepSoundVelocities =
	{
		{
			"5135",
			{
				0xF6, 0x81, 0x00, 0x01, 0x00, 0x00, 0x02, 0x75, 0x24, 0x80, 0xB9, 0x32, 0x01, 0x00, 0x00, 0x09, 0x74, 0x1B, 0xD9, '?', '?', '?', '?', '?', 0x8B, '?', '?', '?', 0x8B, '?', '?', '?', 0xD9, 0x18, 0xD9, '?', '?', '?', '?', '?', 0xD9, 0x19, 0xC2, 0x08, 0x00
			},
			"xxxxxxxxxxxxxxxxxxx?????x???x???xxx?????xxxxx"
		}
	};

	const MemUtils::ptnvec ptnsPerformFlyCollisionResolution =
	{
		{
			"5135",
			{
				0x56, 0x8B, 0xF1, 0x8B, 0x4E, 0x04, 0x8A, 0x81, 0x33, 0x01, 0x00, 0x00, 0x0F, 0xB6, 0xD0, 0x83, 0xFA, 0x01, 0x57, 0x8B, 0x7C, 0x24, 0x0C, 0x77, 0x2B, 0x3C, 0x01, 0x75, 0x0E, 0xD9, '?', '?', '?', '?', '?', 0xD8, '?', '?', '?', '?', '?', 0xEB, 0x02
			},
			"xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx?????x?????xx"
		}
	};

	const MemUtils::ptnvec ptnsCBaseEntity__SetCollisionGroup =
	{
		{
			"5135",
			{
				0x56, 0x8B, 0xF1, 0x8B, 0x86, '?', '?', '?', '?', 0x3B, 0x44, 0x24, 0x08, 0x8D, 0x8E, 0xA4, 0x01, 0x00, 0x00, 0x74, 0x11, 0x8D, 0x54, 0x24, 0x08, 0x52, 0xE8, '?', '?', '?', '?', 0x8B, 0xCE, 0xE8, '?', '?', '?', '?', 0x5E, 0xC2, 0x04, 0x00
			},
			"xxxxx????xxxxxxxxxxxxxxxxxx????xxx????xxxx"
		}
	};


	// vguimatsurface.dll patterns
	const MemUtils::ptnvec ptnsStartDrawing =
	{
		{
			"5135",
			{
				0x55, 0x8B, 0xEC, 0x83, 0xE4, 0xC0, 0x83, 0xEC, 0x38, 0x80, '?', '?', '?', '?', '?', '?', 0x56, 0x57, 0x8B, 0xF9, 0x75, 0x57, 0x8B, '?', '?', '?', '?', '?', 0xC6, '?', '?', '?', '?', '?', '?', 0xFF, '?', 0x8B, 0x10, 0x6A, 0x00, 0x8B, 0xC8, 0x8B, 0x42, 0x20
			},
			"xxxxxxxxxx??????xxxxxxx?????x??????x?xxxxxxxxx"
		}
	};


	const MemUtils::ptnvec ptnsFinishDrawing =
	{
		{
			"5135",
			{
				0x56, 0x6A, 0x00, 0xE8, '?', '?', '?', '?', 0x8B, '?', '?', '?', '?', '?', 0x8B, 0x01, 0x8B, '?', '?', '?', '?', '?', 0x83, 0xC4, 0x04, 0xFF, 0xD2, 0x8B, 0xF0, 0x85, 0xF6, 0x74, 0x09, 0x8B, 0x06, 0x8B, 0x50, 0x08, 0x8B, 0xCE, 0xFF, 0xD2
			},
			"xxxx????x?????xxx?????xxxxxxxxxxxxxxxxxxxx"
		}
	};
}
