...
namespace patterns
{
	namespace engine
	{
		...
		PATTERNS(MiddleOfSV_InitGameDLL,
			"4104",
	...
	namespace client
	{
		PATTERNS(DoImageSpaceMotionBlur,
			"5135",
		...
		PATTERNS(CViewRender__OnRenderStart,
			"2707",
